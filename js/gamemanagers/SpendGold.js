//checks how the golds are spended
game.SpendGold = Object.extend({
    ...
    //when you can buy, load the screen, letters and bind keys
    ...
    //sets directions, skill names and costs
    setBuyText: function() {
    ...
    //unbinds every keys and unpause the game when stop buying
    stopBuying: function() {
        this.buying = false;
    ...
    //make sure the keys are working
